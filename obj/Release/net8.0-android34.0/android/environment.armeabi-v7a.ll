...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 327974969, ; hash 0x138c8039, from name: HowMuch
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 572713214, ; hash 0x2222e8fe, from name: libaot-HowMuch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 66
	...
	%struct.DSOCacheEntry {
		i64 1493165057, ; hash 0x58ffe401, from name: libaot-HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 1694515904, ; hash 0x650042c0, from name: HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 2027538771, ; hash 0x78d9c953, from name: aot-HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 3601477368, ; hash 0xd6aa2ef8, from name: aot-HowMuch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
