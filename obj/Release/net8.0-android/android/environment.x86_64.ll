...
@dso_cache = dso_local local_unnamed_addr global [588 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2591143824657349600, ; hash 0x23f597947ea5fbe0, from name: HowMuch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 77
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5887074454498671702, ; hash 0x51b317067aab7c56, from name: aot-HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 168
	...
	%struct.DSOCacheEntry {
		i64 10653100101203784285, ; hash 0x93d76a1978edf25d, from name: libaot-HowMuch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 331
	...
	%struct.DSOCacheEntry {
		i64 12926289212489600577, ; hash 0xb363678d66680e41, from name: aot-HowMuch
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 15626924335582677217, ; hash 0xd8ddfce3625008e1, from name: libaot-HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 502
	...
	%struct.DSOCacheEntry {
		i64 16091973849880803922, ; hash 0xdf522cf521053a52, from name: HowMuch.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-HowMuch.dll.so
		ptr null; void* handle (0x0)
	}, ; 511
...
@.env.3 = private unnamed_addr constant [37 x i8] c"14905cbd-2171-4688-a50f-1866287519fd\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"com.marginfairy\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-HowMuch.dll.so\00", align 16
